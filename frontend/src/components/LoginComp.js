          ...
          >
            <div className="w-9/10 h-3/4 max-w-[600px] sm:max-w-[700px] md:max-w-[800px] min-h-[400px] max-h-[90vh] bg-white rounded-lg p-4 sm:p-6 shadow-2xl overflow-auto">
                ...
                <div className="flex flex-col items-center justify-center text-black w-full">
                    <div className="flex flex-col items-center justify-center w-full gap-4 text-center mb-4">
                        <div className="w-full sm:w-2/3 h-10">Tu Przycisk do Logowania przez Google</div>
                        <div className="w-full sm:w-2/3 h-10">Tu Przycisk do Logowania przez Facebook ewentualnie</div>
                    </div>
                    ...
                    <button className="text-lg sm:text-xl font-bold/90 w-full sm:w-2/3 h-10 bg-sky-400 text-white rounded-xl hover:bg-sky-600 transition-all duration-300 cursor-pointer mt-4">Zaloguj się</button>
                </div>
